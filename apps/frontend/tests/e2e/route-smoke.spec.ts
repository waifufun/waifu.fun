...
const ROUTES = [
	...
	{ path: "/auth/twitter/finalize?token=test", label: "twitter finalize" },
	...
	{ path: `/profile/${TEST_ADDRESS}`, label: "profile" },
	{ path: `/profile/${TEST_ADDRESS}/components`, label: "profile components" },
