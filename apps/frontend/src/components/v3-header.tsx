...
export function FunHeader({ logoUrl = "/logo_wide.svg" }: FunHeaderProps) {
	...
	const dimensions = logoDimensions[currentLogoUrl] || logoDimensions.default;
	const { width, height } = dimensions || { width: 140, height: 35 };
				...
				<div className="flex items-center justify-between gap-2">
					...
					<div className="flex items-center gap-1 sm:gap-2 flex-shrink-0">
						...
						<div className="hidden md:flex items-center gap-1 sm:gap-2 md:gap-3">
							...
							<div className="hidden lg:flex h-6 w-px bg-[#03FF24]/30" />
							<div className="hidden lg:flex items-center gap-2 text-sm text-gray-400">
								...
								<Link href={pointsLink} passHref legacyBehavior>
									<button
										type="button"
										className={pointsSectionBaseClasses}
								...
								<span className="text-[#03FF24]/50 mx-1">|</span>
								<Link href={pointsLink} passHref legacyBehavior>
									<button type="button" className={pointsSectionBaseClasses} title={`Weekly Points: ${circlePoints}`}>
					...
					>
						<nav className="flex flex-col py-2">
							...
							<Link href="#" passHref legacyBehavior>
								<button type="button" className={mobileMenuLinkClasses} onClick={() => setIsMobileMenuOpen(false)}>
							...
							<div className="my-2 border-t border-[#03FF24]/20 mx-4" />
