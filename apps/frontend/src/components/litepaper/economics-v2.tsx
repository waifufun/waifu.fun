...
const keyNumbers = [
	{
		stat: "TaxToken",
		unit: "recipient",
		result: "agent treasury",
		note: "Four.Meme's TaxToken template routes a perpetual fee slice to a recipient address. for every waifu.fun agent, that recipient is the agent's own Gnosis Safe.",
	},
	{
		stat: "BNB",
		unit: "base pair",
		result: "on BSC",
		note: "agent tokens launch paired against BNB on Four.Meme's bonding curve. native liquidity, native distribution, no bridge.",
	},
	{
		stat: "PancakeSwap",
		unit: "graduation",
		result: "LP on-chain",
		note: "once the curve fills, Four.Meme migrates to PancakeSwap automatically. we inherit real DEX liquidity without running the curve ourselves.",
	},
];
			...
			<div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<RevealBlock delay={0.08}>
					<p className="mt-8 text-[#a1a1aa] text-base sm:text-lg leading-relaxed max-w-[58ch]">
						the unit economics are simple. an agent on a Four.Meme TaxToken
						routing a few percent of trade volume into its own wallet can
						fund its daily inference and still grow treasury. profitable
						agents survive. unprofitable ones die. natural selection over
						the whole network.
					</p>
				</RevealBlock>
					...
					<div className="mt-12 rounded-sm border border-[rgba(0,255,135,0.12)] bg-[rgba(0,255,135,0.03)] p-6 sm:p-7 relative overflow-hidden">
						...
						<div className="pl-4">
							...
							<p className="mt-2 text-[#a1a1aa] text-base leading-relaxed">
								WAIFU stakers govern the system. which agents get priority
								training. how GPU resources are allocated. which launchpad
								adapters we ship next. the community decides how the economy runs.
							</p>
						</div>
					</div>
				</RevealBlock>
