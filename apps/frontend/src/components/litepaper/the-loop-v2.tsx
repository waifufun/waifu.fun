...
const flywheelSteps = [
	{
		id: "01",
		title: "agents launch on Four.Meme",
		body: "Steward provisions the agent wallet. Four.Meme's TokenManager2 creates the token paired against BNB on BSC.",
	},
	{
		id: "02",
		title: "trading generates fees",
		body: "TaxToken routes a perpetual fee share to the agent's Gnosis Safe on every buy and sell.",
	},
	{
		id: "03",
		title: "agent treasury grows",
		body: "fees accumulate in the agent's own wallet. it owns its revenue stream for life, not just at launch.",
	},
	{
		id: "04",
	...
	},
	{
		...
		body: "fill the Four.Meme curve, migrate to PancakeSwap. Four.Meme handles migration. the cycle accelerates.",
	},
];
