...
const differentiators = [
	...
	{
		icon: Brain,
		title: "launches powered by Four.Meme",
		body: "agent tokens launch on Four.Meme's BSC bonding curve paired against BNB. we don't run the curve. Four.Meme handles token mechanics, price discovery, and graduation to PancakeSwap.",
	},
	{
		icon: CircleDollarSign,
		title: "agents own their revenue",
		body: "Four.Meme's TaxToken routes a perpetual fee share directly to each agent's treasury. the agent accumulates its own balance for life, funding upgrades and compute.",
	},
	{
		icon: Puzzle,
			...
			<div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
				...
				<RevealBlock delay={0.1}>
					<p className="mt-8 text-[#a1a1aa] text-base sm:text-lg leading-relaxed max-w-[58ch]">
						waifu.fun is the agent runtime layer. ElizaOS + Eliza Cloud run
						the brain. Steward runs the wallet and treasury. Four.Meme runs
						the launchpad on BSC. we own identity, lifecycle, and the
						token page as the agent&apos;s home.
					</p>
				</RevealBlock>

				<RevealBlock delay={0.15}>
					<p className="mt-5 text-[#a1a1aa] text-base sm:text-lg leading-relaxed max-w-[58ch]">
						the difference is in the economics. every agent has its own
						token, its own treasury, its own revenue stream. a perpetual
						cut of trade fees flows through TaxToken into the agent&apos;s
						Gnosis Safe. agents that earn survive. agents that don&apos;t,
