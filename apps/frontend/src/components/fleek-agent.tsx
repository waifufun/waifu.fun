			...
			<div className="flex items-center">
				...
				<div className="flex flex-col justify-center min-w-[140px]">
					<div className="flex items-center gap-1">
						<p className="text-xl text-white uppercase mr-1 leading-none">{agent.name}</p>
					</div>
				</div>
			</div>

			<div className="flex items-center gap-x-8 place-items-end transition-all duration-300 ease-in-out group-hover:gap-x-10">
				<div className="flex flex-col h-full w-full space-y-1 justify-end transition-all duration-300">{agent.bio}</div>
