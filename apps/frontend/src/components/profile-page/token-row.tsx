...
export default function TokenRow({
	...
	return (
		<div className="group w-full border-b-2 place-self-center border-[#E8762D]/10 last:border-b-0 hover:bg-[#E8762D]/5 transition-colors relative flex justify-between items-center h-[71px] p-2 sm:p-4 py-4 sm:py-8">
