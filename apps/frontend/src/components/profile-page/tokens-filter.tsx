			...
			{buttons.map((btn) => {
				...
				return (
					<button
						...
						className={`text-xs px-3 cursor-pointer py-1 h-auto rounded-none border-2 ${isActive ? "border-black bg-[#00FF87] text-black hover:bg-[#02e020]" : "border-transparent text-gray-300 hover:text-[#00FF87] hover:bg-[#00FF87]/10 hover:border-[#00FF87]/50"}`}
					>
						{btn.label}
					</button>
				);
