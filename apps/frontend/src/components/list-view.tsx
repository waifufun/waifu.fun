				...
				{tokens.map((token: IToken) => {
					...
					return (
						...
						>
								...
								<div className="flex items-center gap-3">
									...
									<div className="flex flex-col gap-2.5">
										...
										<div className="flex items-center gap-1.5">
											...
											<span className="text-lg font-medium uppercase text-[#71717a] truncate">{token.ticker}</span>
										...
										{typeof token?.curveProgress === "number" && !token?.curveCompleted ? (
											<div className="flex flex-col gap-2.5 max-w-[275px]">
												<div className="text-[#e4e4e7] text-base font-medium font-satoshi leading-none inline-flex gap-2">
													Progress
													<span className="text-[#00ff87] font-normal">{token.curveProgress.toFixed(2)}%</span>
												</div>
							...
							<TableCell className="text-right text-[#71717a] rounded-r-lg">
