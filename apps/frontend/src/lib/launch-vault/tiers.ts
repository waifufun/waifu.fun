...
export const LAUNCH_TIERS: Record<LaunchTier, LaunchTierInfo> = {
	...
	TIER_TEST: {
		...
		v2BuyBnb: 0.5,
		circulatingSupplyM: 500,
		openCircMcUsdHint: "smoke-test tier",
		openFdvUsdHint: "smoke-test tier",
		presaler2xMultiple: "smoke-test terms",
		vestingEnabled: false,
	},
};
...
export function tierFromCapWei(capWei: bigint | null | undefined): LaunchTierInfo {
	...
	const ETHER = 10n ** 18n;
	if (capWei === 17_340_000_000_000_000_000n) return LAUNCH_TIERS.TIER_TEST;
