...
export default function UpdateSocialsModal({ open, onClose, token, onSuccess }: UpdateSocialsModalProps) {
	...
	return (
		...
		>
			<div
				className="bg-zinc-900 border border-[#FF2D78]/40 shadow-lg w-full max-w-md p-6 relative"
			...
			>
				...
				<h2 className="text-lg font-bold mb-4 text-[#FF2D78]">Update Token Socials</h2>
