	...
	return (
		...
		>
			...
			<button
				...
				className="border border-[#E8762D] rounded-sm hover:cursor-pointer px-4 py-2 text-base uppercase font-[500]"
				onClick={() => {
					if (!prompt) {
		...
		<>
			<div className="w-full max-w-6xl mx-auto px-4 py-8">
				<Tabs defaultValue="auto" className="w-full">
					<TabsList className="grid w-full grid-cols-3 bg-black border-2 border-[#E8762D]/50 rounded-none shadow-[4px_4px_0px_rgba(255,45,120,0.3)] mb-6">
						<TabsTrigger
							value="auto"
							className="text-sm data-[state=active]:bg-[#E8762D] data-[state=active]:text-black data-[state=active]:shadow-[inset_0px_0px_0px_2px_black] 
                     text-gray-300 hover:text-[#E8762D] hover:bg-[#E8762D]/10 rounded-none py-3 font-bold uppercase tracking-wider
                     border-r border-[#E8762D]/50 data-[state=active]:border-r-[#b31f57]"
						>
							Auto
						</TabsTrigger>
						<TabsTrigger
                     ...
                     border-x border-transparent data-[state=active]:border-x-[#b31f57]"
						...
						<TabsTrigger
							...
							className="text-sm data-[state=active]:bg-[#E8762D] data-[state=active]:text-black data-[state=active]:shadow-[inset_0px_0px_0px_2px_black] 
                     text-gray-300 hover:text-[#E8762D] hover:bg-[#E8762D]/10 rounded-none py-3 font-bold uppercase tracking-wider
                     border-l border-[#E8762D]/50 data-[state=active]:border-l-[#b31f57]"
						>
							Import
						</TabsTrigger>
					</TabsList>
