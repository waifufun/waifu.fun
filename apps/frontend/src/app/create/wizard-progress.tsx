							...
							<div className="flex flex-col items-center">
								<button
									...
									className={cn(
										...
										isActive &&
											"bg-[#03FF24] text-black border-[#03FF24] shadow-[0_0_12px_rgba(3,255,36,0.4)]",
										isCompleted &&
											"bg-[#03FF24]/20 text-[#03FF24] border-[#03FF24]/60 hover:bg-[#03FF24]/30 cursor-pointer",
										!isActive &&
											!isCompleted &&
								...
								<span
									className={cn(
										...
										isActive && "text-[#03FF24]",
										isCompleted && "text-[#03FF24]/60",
							...
							{idx < WIZARD_STEPS.length - 1 && (
								<div
									className={cn(
										...
										idx < stepIndex ? "bg-[#03FF24]/40" : "bg-gray-800",
									)}
								/>
							)}
						</div>
