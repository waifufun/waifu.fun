...
const FLOW = [
	{
		...
		body: "a creator or delegated agent runtime signs with a steward key and triggers the FLAP Portal launch. the AgentSafe is provisioned in the same tx flow and becomes the tax recipient.",
	},
	{
