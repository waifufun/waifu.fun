		...
		<div className="min-h-screen bg-[#08080a] overflow-x-hidden">
			...
			<section ref={heroRef} className="relative py-28 sm:py-40 overflow-hidden min-h-[90vh] flex items-center">
				...
				<div
					...
					style={{
						background: "radial-gradient(ellipse at 50% 0%, rgba(0,255,135,0.08) 0%, transparent 50%)",
					}}
				/>
				<div
					className="absolute inset-0"
					style={{
						background: "radial-gradient(ellipse at 80% 50%, rgba(192,132,252,0.05) 0%, transparent 40%)",
					}}
				/>
								...
								>
									...
									>
										<div
											...
											style={{
												background: "radial-gradient(ellipse, rgba(0,255,135,0.25) 0%, transparent 60%)",
											}}
										/>
									</motion.div>
									{/* Halo ring */}
										...
										<div className="relative lg:py-8">
											...
											<motion.div
												...
												style={{
													...
													border: `2px solid ${phase.accent}40`,
												}}
													...
													>
														...
														{phase.phase === "revival" && (
															<motion.div
																...
																style={{
																	background: "radial-gradient(circle at 50% 50%, rgba(0,255,135,0.3) 0%, transparent 60%)",
																}}
															/>
														)}
			...
			<section id="infrastructure" className="relative py-24 sm:py-32 scroll-mt-20">
				<div
					className="absolute inset-0"
					style={{
						background: "radial-gradient(ellipse at 20% 50%, rgba(0,255,135,0.03) 0%, transparent 50%)",
					}}
				/>
								...
								>
									<div className="flex items-start gap-5">
										<div className="flex-shrink-0 w-14 h-14 rounded-sm bg-[#00ff87]/10 flex items-center justify-center">
											<span className="font-mono text-xl font-bold text-[#00ff87]">
												{item.step}
											</span>
										</div>
										<div>
						...
						>
							...
							<div className="pl-4">
								...
								<p className="text-[#a1a1aa] text-base mt-2 leading-relaxed">
									...
									<span className="text-[#71717a] block mt-2 text-sm">
										stop trading? cycle breaks. agent dies.
									</span>
								</p>
							</div>
						</div>
			...
			<section className="relative py-28 sm:py-40">
				<div
					className="absolute inset-0"
					style={{
						background: "radial-gradient(ellipse at 50% 100%, rgba(0,255,135,0.1) 0%, transparent 50%)",
					}}
				/>
				<div
					className="absolute inset-0"
					style={{
						background: "radial-gradient(ellipse at 50% 0%, rgba(192,132,252,0.03) 0%, transparent 40%)",
					}}
				/>
						...
						<div className="text-center">
							...
							<div className="mt-10 flex items-center justify-center gap-6 flex-wrap">
								<div className="flex items-center gap-2 text-[#52525b] text-sm">
									<span className="font-mono text-[#00ff87]">$<AnimatedCounter target={847} />K</span>
									<span>volume 24h</span>
								</div>
								<span className="text-[#333]">•</span>
								<div className="flex items-center gap-2 text-[#52525b] text-sm">
									<span className="font-mono text-[#00ff87]"><AnimatedCounter target={156} /></span>
