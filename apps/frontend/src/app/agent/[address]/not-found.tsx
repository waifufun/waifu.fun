		...
		<main className="flex min-h-[100dvh] items-center justify-center px-6 text-white">
			<SurfaceCard padding="lg" className="w-full max-w-md text-center">
				<div className="font-mono text-[11px] uppercase tracking-[0.24em] text-white/40">
					{t("agent.notFound.eyebrow")}
				</div>
				<h1 className="mt-3 text-2xl tracking-tight md:text-3xl">{t("agent.notFound.title")}</h1>
				<p className="mx-auto mt-3 max-w-[44ch] text-sm leading-relaxed text-white/55">{t("agent.notFound.body")}</p>
				<div className="mt-7 flex items-center justify-center">
					...
					>
						...
						{t("agent.notFound.browseAllAgents")}
					</Link>
				</div>
			</SurfaceCard>
		</main>
