	...
	return (
		<div className="min-h-[100dvh] bg-black text-white flex items-center justify-center px-6">
			<div className="max-w-md w-full text-center">
				...
				<h1 className="text-2xl md:text-3xl tracking-tight mb-3">
					agent not found
				</h1>
				<p className="text-sm text-white/50 leading-relaxed mb-8">
					this address doesn't map to any agent we know. maybe it
					never launched, maybe it's still booting, or maybe the
					address is off.
				</p>
				<Link
					href="/"
