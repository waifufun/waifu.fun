	...
	return (
		<div className="flex flex-col flex-1 min-h-[100vh]">
			<div className="w-full max-w-5xl mx-auto px-4 py-12">
				{/* Page Header */}
				<div className="mb-10">
					<h1 className="text-2xl font-bold text-[#e4e4e7] tracking-tight">Platform Terms & Conditions</h1>
					<p className="text-lg font-medium text-[#a1a1aa] mt-2">Last Updated: 31 January 2025</p>
				</div>
