...
Whether your use of the platform or any of its components requires an account or not, you are responsible for all activities that occur with respect to your use of the platform, regardless of whether the activities are authorized by you or undertaken by you. Should you believe your password or security for the platform has been breached in any way, you must immediately notify us.`,
	...
	{
		header: "Our Intellectual Property Rights",
		content: `
...
For avoidance of doubt, your use of the platform does not grant you any rights in or ownership over any of the platform’s content.
	...
	{
		header: "Assumption of Risk and Responsibility",
		subheader:
		...
		content: [
			"our continued provision of the platform or services thereon, which we may limit or cease to provide at any time for any reason in our sole discretion",
			"the continued functionality of blockchain or other infrastructure (decentralized or otherwise) required for use and functionality of the platform, which you acknowledge we have no ability or obligation to control or support",
			"the risk of loss, including from phishing or other social engineering attacks, resulting the loss of digital currency, tokens, and assets",
			"cyber-attacks, including on blockchain or other infrastructure that we have limited of no ability to protect, control, or modify",
			"your access to your digital currency, tokens, and assets may be suspended or terminated, including for violation of these terms and conditions, or there may be a delay in your access or use of your digital currency, tokens, and assets, including as a result of platform maintenance, upgrades, or interruptions for any reason;",
			...
			"statutory and regulatory changes or actions governing blockchain, crypto assets, tokens, and other features required for platform use and functionality are uncertain and may adversely affect our willingness or ability to continue supporting and your ability to use or access the platform and all assets or functionality thereof.",
			"By using the platform, you expressly agree that:",
			"we may discontinue any portion of the platform or services, at any time, for any reason, in our sole discretion;",
			"digital assets are volatile, and creation and investment may result in substantial losses. You are solely responsible for assessing your investments, your financial situation, and your risk tolerance;",
			"you are solely responsible for safekeeping of any private keys, recovery phrases, passwords, or similar protectors;",
			"you, and not we, are responsible for detecting, preventing, and not facilitating third-party fraud, and we are not liable for losses resulting from your failure to detect, prevent, or avoid facilitate with third-party fraudsters;",
			"you are solely responsible for knowing and adhering to all applicable laws, regulations, and tax requirements including related to digital currency, tokens, assets, intellectual property, hateful or unlawful speech or media, and AI-generated content in your jurisdiction;",
			"you are not (a) the subject of economic or trade sanctions administered or enforced by any governmental authority or otherwise designated on any list of prohibited parties (including but not limited to the list maintained by the U.S. Office of Foreign Assets Control of the U.S. Department of the Treasury) or (b) a citizen, resident, or organized in a jurisdiction or territory that is the subject of comprehensive economic country-wide, territory-wide, or regional economic sanctions by the United States or any other jurisdiction.",
			"Purchase and ownership of digital currency and digital assets does not grant equity, intellectual property rights, or financial returns;",
			"your decision to use the platform is yours and yours alone and you must not and will not rely exclusively on our content, actions, information, recommendations, omissions, materials, publications, decisions, or statements and should seek qualified professional advice where necessary.",
			"Your use of the platform may give you access to certain AI tools and/or AI-powered agents. You understand that such tools are experimental in nature and that the advice you may obtain from them may contain hallucinations and other errors.",
			"no guarantees are made regarding the future value, performance, or utility of digital currency, tokens or assets.",
		],
	},
	{
		header: "Disclaimer",
...
A court of competent jurisdiction shall have the authority to enforce these Mass Filing provisions and, if necessary, to enjoin the mass filing, prosecution, or administration of arbitrations and the assessment of arbitration fees. If these additional procedures apply to your claim, and a court of competent jurisdiction determines that they are not enforceable as to your claim, then your claim will proceed before JAMS pursuant to the JAMS Mass Arbitration Procedures and Guidelines (available at https://www.jamsadr.com/mass-arbitration-procedures). If a court of competent jurisdiction also determines that the JAMS Mass Arbitration Procedures and Guidelines are not enforceable as to your Claim, then the remaining Claims shall be subject to Option One or Option Two above as selected by you or us.
	...
	},
	{
		...
		content: [
			...
			"Engage in unregistered securities offerings",
			"Attempt to evade sanctions imposed by the Office of Foreign Assets Control",
			"Participate in money laundering or terrorism financing activities",
			"Use the platform for illegal or fraudulent activities, including tax evasion or circumventing financial reporting obligations",
			"Use the platform from restricted regions, including jurisdictions subject to US sanctions.",
		],
	},
	{
		content:
		...
		<div className="flex flex-col flex-1 min-h-[100vh]">
			<div className="flex flex-col gap-4 container">
				<div className="flex flex-col gap-4">
					<h1 className="text-3xl font-bold">Platform Terms & Conditions</h1>
					<div className="text-lg font-medium">Last Updated: 31 January 2025</div>
				</div>
