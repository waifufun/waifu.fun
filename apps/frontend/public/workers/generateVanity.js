    ...
    if (typeof event.data === "object" && event.data.suffix !== undefined) {
        ...
        try {
            ...
            while (running) {
                ...
                count++;
                if (!running)
                    break; // Check running flag again after potentially lengthy crypto ops
