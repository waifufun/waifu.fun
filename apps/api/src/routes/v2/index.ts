...
import agentTradingDepositRoutes from "./agents-trading-deposit.js";
import agentTradingPolicyRoutes from "./agents-trading-policy.js";
...
import agentCapabilityRoutes from "./agents/capabilities.js";
import agentCapabilityActionRoutes from "./agents/capability-actions.js";
import agentCreditsOffRampRoutes from "./agents/credits-offramp.js";
...
v2.route("/agents", agentChatRoutes);
v2.route("/agents", agentTradingDepositRoutes);
v2.route("/agents", agentTradingPolicyRoutes);
...
v2.route("/agents", agentCreditsOffRampRoutes);
v2.route("/agents", agentHyperliquidRoutes);
v2.route("/agents", agentCapabilityRoutes);
v2.route("/agents", agentCapabilityActionRoutes);
