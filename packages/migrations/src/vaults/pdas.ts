...
//constants
export const LOCKING_PROGRAM = new anchor.web3.PublicKey("LockrWmn6K5twhz3y9w1dQERbmgSaRkfnTeTKbpofwE");
...
// PDAs
export function getVaultConfig(programId: anchor.web3.PublicKey): anchor.web3.PublicKey {
	return anchor.web3.PublicKey.findProgramAddressSync([Buffer.from(VAULT_CONFIG_SEED)], programId)[0];
}
