import { Connection, PublicKey, Transaction, SystemProgram, sendAndConfirmTransaction, TransactionMessage, VersionedTransaction, TransactionConfirmationStatus, Keypair } from '@solana/web3.js';
import { TOKEN_PROGRAM_ID, getAssociatedTokenAddressSync, createAssociatedTokenAccountInstruction, createTransferInstruction } from '@solana/spl-token';
import type { MigrationContext } from '../types';
import DB from '@autofun/database';
import { BN } from '@coral-xyz/anchor';
import type { ProtocolState, ProtocolMigration } from '../types';
