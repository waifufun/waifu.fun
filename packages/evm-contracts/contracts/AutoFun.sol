...
import "./interfaces/IAutoFun.sol";
import "./interfaces/IAutoFunToken.sol";
    ...
    IAutoFun
{
    ...
    IAutoFunTokenFactory public factory;
    ...
    function updateFactory(address _factory) external onlyOwner {
        factory = IAutoFunTokenFactory(_factory);
        emit AutoFunTokenFactoryUpdated(_factory);
    }
    ...
    function _launch(
        ...
        IAutoFunToken(deployedTokenAddress).mintToken(
