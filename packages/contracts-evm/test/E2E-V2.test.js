...
describe("E2E V2 Lifecycle", function () {
  let waifu, waifuFun, factory, feeRouter, staking;
  let owner, alice, bob, platform, treasury;
  ...
  it("should deploy full V2 system", async function () {
  ...
  it("should create agent token with correct supply split", async function () {
  ...
  it("should track multiple agents by creator", async function () {
