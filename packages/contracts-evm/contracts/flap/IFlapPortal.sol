...
/// @title IFlapPortal
/// @notice Flap Portal V6 entry point. BundleRouter calls this exactly
///         once per launch to atomically mint a TOKEN_TAXED_V3, fill the
///         curve at the dex-thresh, and migrate to PancakeSwap V2.
