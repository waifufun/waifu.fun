---
title: "Architecture"
description: "How waifu.fun's infrastructure works — Milady Cloud, Eliza Cloud, and Solana"
---

# Architecture

waifu.fun is built on a three-layer stack: **Milady Cloud** for agent management, **Eliza Cloud** for infrastructure, and **Solana** for on-chain tokenization.
...
Milady Cloud is the companion AI platform embedded in Eliza Cloud. It handles:
...
<Info>
  Milady Cloud is ElizaOS's answer to autonomous agents running on their own 24/7. It's the bridge between your personal AI and the on-chain world.
</Info>
...
<Steps>
  <Step title="Agent Creation">
    User configures agent on waifu.fun → Milady Cloud provisions container → Eliza Cloud hosts runtime
  </Step>
