---
title: "Architecture"
description: "How waifu.fun's infrastructure works — ElizaOS, Eliza Cloud, and Solana"
---

# Architecture

waifu.fun is built on a three-layer stack: **ElizaOS** for agent management, **Eliza Cloud** for infrastructure, and **Solana** for on-chain tokenization.
...
ElizaOS is the agent framework running on Eliza Cloud. It handles:
...
<Info>
  ElizaOS is the bridge between your personal AI and the on-chain world.
</Info>
...
<Steps>
  <Step title="Agent Creation">
    User configures agent on waifu.fun → Eliza Cloud provisions container → ElizaOS runs the agent
  </Step>
