...
- **treasury LP allocation.** when the bundle runs, a flat 100M tokens (10% of
  supply) goes to `TreasuryLP4`. these tokens get progressively deployed as
...
| `TreasuryLP4` (V3 LP ladder) | 100M tokens (10% of supply) |
...
- 65% of every BNB claim from `TreasuryLP4` as the V3 ladder deploys
